    ...
    <nav id="navBar" style="height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
        <ul style="height: 100%; display: flex; flex-direction: column; justify-content: space-between; padding: 0; margin: 0; list-style: none;">
            <div class="upperPart">
                ...
                <li title="Contacts" class="mt-3"><a href="contact.php"><img src="assets/images/group.svg" alt="contacts" width="50"></a></li>
            </div>
            <div>
                <li title="Log out" class="mb-3"><a href="logout.php"><img src="assets/images/turnoff.svg" alt="log out" width="50"></a></li>
